...
namespace Zenkoi.BLL.Services.Interfaces
{
    public interface IBreedingProcessService
    {
        ...
        Task<bool> CancelBreeding(int id, string note);
        ...
        Task<List<BreedingParentDTO>> GetParentsWithPerformanceAsync(double minHatchRate,double minSurvivalRate,string? variety = null
);
