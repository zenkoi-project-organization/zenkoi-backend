...
namespace Zenkoi.DAL.Migrations
{
    ...
    [Migration("20251210145555_MoveImagesFromWorkScheduleToStaffAssignment")]
    partial class MoveImagesFromWorkScheduleToStaffAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zenkoi.DAL.Entities.CartItem", b =>
                {
                    ...
                    b.HasIndex("CartId", "KoiFishId")
                        .IsUnique()
                        .HasFilter("[KoiFishId] IS NOT NULL");

                    b.HasIndex("CartId", "PacketFishId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Zenkoi.DAL.Entities.KoiFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerId", "KoiFishId")
                        .IsUnique();

                    b.ToTable("KoiFavorites", "dbo");
                });
            ...
            modelBuilder.Entity("Zenkoi.DAL.Entities.ShippingDistance", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "MinDistanceKm", "MaxDistanceKm");
